...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Baltimore family events for ${newsletter.dateRange || "this weekend"}. AI-curated picks from 310+ sources across 5 counties.`,
    openGraph: {
      title: newsletter.title,
      description: `Baltimore family events for ${newsletter.dateRange || "this weekend"}. Curated from 310+ sources.`,
    },
  };
}
