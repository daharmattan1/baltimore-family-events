...
export const metadata: Metadata = {
  ...
  description:
    "Built by a Baltimore dad tired of scrolling 310+ sources. Learn how 5 AI parent personas gather family events from 310+ sources across 5 counties.",
  openGraph: {
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-[var(--color-harbor)] mb-4 leading-relaxed">
                  ...
                  gather intelligence for businesses now scan 310+ sources every week. Five AI parent personas
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-[var(--color-charm)]/5 rounded-2xl p-6 text-center border border-[var(--color-charm)]/10">
              <div className="text-4xl font-display font-bold text-[var(--color-charm)]">310+</div>
